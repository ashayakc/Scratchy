...
import { CardOptionService } from '../card-options/card-option.service';
...
export class CardComponent implements OnInit {
   ...
   constructor(private giftOptionService :CardOptionService){}


  isDrawing: boolean;
  lastPoint: any;
  container: any = document.getElementById('js-container');
  canvas: any = document.getElementById('js-canvas');
  ctx: any;
  ...
  ngOnInit() {
    this.giftOption = this.giftOptionService.getGiftOption();
    this.giftValue = this.giftOptionService.getGiftValue();

    this.image.src = 'http://localhost:4200/assets/GreemScratchCard.png';
